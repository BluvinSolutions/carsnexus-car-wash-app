...
class AppColors {
  static const Color primary = Color(0xFF4E65FF); // Primary-500 - Main color
  static const Color primary50 =
      Color(0xFFE6EFFD); // Primary-50 - Lighter shade of main color
  ...
  static const Color surface =
      Color(0xFF000000); // Background color for cards, dialogs, and sheets
